<template>
    <div class="container-fluid" id="main" style="border: 0; padding-top: 40px; padding-bottom: 170px">
        <div class="row">
            ...
            <!--<h1>TFT</h1>-->
            <div class="col-md-8">
                <img src="../../assets/TFT/tft_first.png">
                <div>
                    ...
                    <p><strong>Context:</strong> Thirsty for Thirty (TFT) is an online language institute.
                        ...
                        (1) <i>feedback card</i> for TFT students after each course and (2) an <i>speech practice tool</i>
                ...
                <div>
                    ...
                    <div class="competitive">
                        ...
                        <img src="../../assets/TFT/flowchart.png">
                    ...
                    <div class="persona">
                        ...
                        <ol>
                            <li>I changed the first page and made it look brighter</li>
                            <li>I changed the three icons in the tab bar from TFT logos to black-grey uniformed icons</li>
                        </ol>
