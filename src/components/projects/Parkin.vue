<template>
    <div class="container-fluid" id="main" style="border: 0; padding-top: 40px">
        <div class="row">
            <Sidebar :indexes="indexes" class="col-md-3 offset-md-1"></Sidebar>
            <div class="col-md-6">
                ...
                <hr>
                <h1 id="i-cd">02 / Conceptual Design</h1>
                <div>
                ...
                <hr>
                <h1 id="i-id">03 / Interaction Design</h1>
                ...
                <hr>
                <h1 id="i-ut">04 / Usability Test</h1>
                ...
                <hr />
                <h1 id="i-rt">05 / Reflection & Takeaways</h1>
            </div>
        </div>
    </div>
</template>
